...
from database.NoteBot import TranscriptionService

from database.NoteBot import AuthService
from database.NoteBot.models import CallDetails, UserRegister, UserLogin, ParticipantModel, CallDetailsModel
